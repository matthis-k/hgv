...
public interface Representation {
    ...
    /**
     * This method is used to get the Drawable object that represents the given node.
    ...
    /**
     * This method calculates the way the Edge should be represented, depending on the current accuracy in the
     * representation.
